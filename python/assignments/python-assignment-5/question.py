...
if command == "login":
    ...
    print("registeration in progress")
    ...
    if username in users_db:
        ...
        choice = input("Do you want to verify your account now for $1500 (Yes/No): ").lower()
        if choice == "yes":
            print("You will be charged the sum of $1500 from your balance")
            if users_db[username]["balance"] >= verification_amount:
