...
# using the len function to print the number of every student in each list category
...
print()
print("All Average Performers:", average_performers)
print()
print("All Low Performers:", low_performers)
