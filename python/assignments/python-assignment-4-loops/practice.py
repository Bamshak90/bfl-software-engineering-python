...
for student in students:
  ...
  if score >= 70:
    High_perfomers.append(student_entry)
  elif score <= 50 and score < 70:
    Average_perfomers.append(student_entry)
  else:
    low_perfomers.append(student_entry)


print("High performers are: \n", len(High_perfomers))
print("Average performers are: \n", len(Average_perfomers))
print("Low performers are: \n", len(low_perfomers))
